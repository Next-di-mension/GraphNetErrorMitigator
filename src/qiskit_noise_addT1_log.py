...
def parse_arguments():
    ...
    parser.add_argument('--config', type=str, default='src/config/h4.yml', help='Path to config file')
...
def configure_logging():
    logging.basicConfig(filename='vqe_log.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def main(args):
    ...
    # Log parameters
    # logging.info("VQE Simulation Parameters:")
