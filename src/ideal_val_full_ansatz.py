...
for i in range(11, num_params + 11):
...
for n in range(len(exitations)):
    if exitations[n][0][1] == 0 and  exitations[n][1][1] == 0:
        qc = single_excitation_circ(qc, exitations[n][0][0], exitations[n][1][0], T2_angle[n])
    else:
        qc = double_excitation_circ(qc, exitations[n][0][0], exitations[n][0][1], exitations[n][1][0], exitations[n][1][1], T2_angle[n])
